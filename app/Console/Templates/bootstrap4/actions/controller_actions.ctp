 ...
 */
	public function <?php echo $admin ?>view($id = null) {
		...
		$options = array('conditions' => array($this-><?php echo $currentModelName; ?>->alias . '.' . $this-><?php echo $currentModelName; ?>->primaryKey => $id));
...
?>
        $fields = array();
        $blacklist = array();
        $this->set(compact('fields', 'blacklist'<?php echo $compact; ?>));
	}
