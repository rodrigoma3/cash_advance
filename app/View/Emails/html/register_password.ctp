<fieldset>
    <legend><?php echo __('Register Password'); ?></legend>
    <h1><?php echo __('Hello %s!', $user['User']['name']); ?></h1>
    <br>
    <h3><?php echo __('Click the button below to create your password to access the %s.', Configure::read('AppProperties.app_name')); ?>
    <br>
    ...
    <br>
    <p><?php echo __('This link will expire on: %s', $user['User']['token_expiration']); ?></p>
    <br>
    <p><?php echo __('In case of doubts, please contact the system administrator at %s.', Configure::read('AppProperties.administrator_email')); ?></p>
</fieldset>
